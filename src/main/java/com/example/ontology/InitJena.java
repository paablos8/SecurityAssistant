...
public class InitJena {
	...
	public  void loadOntology () {
			...
			//the Mueller2023_Security_shortened ontology is replicated locally on the disk.
			//filePath = "file:///C:/Users/tscha/Development/SecurityAssistant/src/main/java/com/example/ontology/files/Mueller2023_Security.owl";
			filePath = "file:/C:/Users/Wiwi-Admin/eclipse-workspace/SecurityAssistant/src/main/java/com/example/ontology/files/Mueller2023_Security.owl";
			...
			// The locally stored ontology is used because: 1.) no risk for a delay when accessing URLs 
	...
	public void addOrganization (String userName, String nameOfOrganization, int numberOfEmployees, String industry, String bundesland) {
			...
			// Creates an instance of the type 'Organization' with the IRI consisting of the Prefix + the name provided by the user.
			...
			// Get the object property assertion 'organization_has_NumberOfEmployeesto' to later relate the number of employees to the organization instance.
			...
			// Creates an object property assertion to relate the number of employees to the just added organization instance.
	...
	public void addPasswordPolicy (String pwChange, String pwProperties) {
		...
		// Depending on the answers the user gave, the system decides whether the organization meets the requirements for a password policy or not.
			// These decision rules are based on ISO 27001 Question 11.3.1 e) and on our individual thoughts.
			// The official ISO 27001 document askes over 20 question to determine the strength of the password security management in companies - 
	...
	public void addPolicy (String typeOfPolicy, String implementedPolicy) {
		// Because the ontology has different prefixes (depending which (imported) ontology provided the specific type of asset),
		// we need to check which prefix is used for the specific policy class.
		// The following checks which prefix the IRI of the policy type contains, which the instance should be the type of.
	...
	public void addAsset (String typeOfAsset, String addedAsset) {
		...
		// The following checks which prefix the IRI of the asset type contains, which the instance should be the type of.
		// Unfortunately this increases the runtime.
		String currentNS; 
	...
	// Some assets needs to be related to a section instance, where the asset is located. 
	// Additionally, the section needs to be related to a building instance, where the section is located.
	// Additionally, the building needs to be related to an organization, to which the building belongs.
	public void addAssetToBuilding (String building, String implementedAsset, String typeOfAsset) {
		...
		// The EntryCheckpoint does not have to be related to a section - thus, we can skip that for every EntryCheckpoint instance.
